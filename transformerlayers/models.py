...
from transformerlayers.HSAM import PosEncoding
from transformerlayers.CCMID import EncoderLayer, DecoderLayer,EncoderLayer1,DecoderLayer2
...
class Transformer(nn.Module):
    ...
    def encode(self, enc_inputs,return_attn=True):
